      ...
      try {
          ...
          if (err.message !== "Aborted") {
              if (err.message.startsWith("QUOTA_EXCEEDED")) {
                  alert("Rate Limit or Quota Exceeded: " + (err.message.split("|")[1] || "Please wait a minute or check your API key."));
              } else {
                ...
                <div className="space-y-6 animate-slide-up-fade h-full flex flex-col">
                    {!showGenConsole ? (
                        ...
                        <div className="flex-1 flex flex-col min-h-[120px]">
                            ...
                            <div className="relative flex-1 flex flex-col">
                                <DebouncedTextarea className="w-full flex-1 bg-black border border-zinc-800 p-4 text-zinc-200 focus:border-orange-500/50 outline-none resize-none transition-all duration-300 font-light leading-relaxed shadow-inner rounded-md" placeholder="e.g. Create the main antagonist from this book..." value={genPrompt} onDebounceChange={(val) => setGenPrompt(val)} />
